    ...
    return (
        <Grid columns={2} relaxed='very'>
            <Grid.Column>
                ...
                <p>
                CarbonKnight is an app designed to help users estimate and track their 
                transportation-related carbon footprint over time. This project consisted of a Rails front end, 
                a Rails back end API, and a Sinatra microservice.
                </p>
